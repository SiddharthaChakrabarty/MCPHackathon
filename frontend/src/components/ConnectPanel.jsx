...
export default function ConnectPanel({
    ...
    const connectors = useMemo(
        () => [
            ...
            // NOTE: google-meet and google-calendar are treated as separate outbound apps in Descope
            { id: "google-meet", title: "Google Meet", description: "Meet scheduling & links", colorClass: "google-bg", Icon: SiGoogle },
            ...
            { id: "discord", title: "Discord", description: "Community & voice channels", colorClass: "discord-bg", Icon: SiDiscord },
